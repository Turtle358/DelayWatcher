...
public class TOCBrandHelper {
    ...
    static {
        ...
        officialColours.put("Caledonian Sleeper", "#1A2F33");
        officialColours.put("Grand Central", "#000000");
        officialColours.put("Grand Central - North West", "#000000");
        officialColours.put("Lumo", "#00B2E2");
        ...
        officialColours.put("West Midlands Railway", "#ff8200");
    }
    ...
    public static String getNameForCode(String code) {
        ...
        switch (code.toUpperCase()) {
            ...
            case "WM": return "West Midlands Railway";
            default:
                return code;
        }
    }
